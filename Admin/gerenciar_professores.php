                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td class="action-links">
                                    ...
                                    <a href="excluir_professor.php?id=<?php echo $row['id_professor']; ?>" onclick="return confirm('Tem certeza que deseja Inativar este professor?')" class="deactivate-link"><i class="fa-solid fa-user-slash"></i> Inativar</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
